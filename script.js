...
const musicTracks = [
  {
    ...
    file: 'Running_the_show.mp3',
    fallbackFile: 'music/DIGITAL_CIRCUS_-_The_One_Who_s_Running_the_Show_Official_Music_Video.mp3',
    duration: '3:02'
  },
  {
    title: 'Your New Home',
    file: 'your_new_home.mp3',
    fallbackFile: 'music/Your_New_Home.mp3',
    duration: '3:00'
  },
  {
    title: 'Theme from The Amazing Digital Circus',
    file: 'Main_theme.mp3',
    fallbackFile: 'music/The_Amazing_Digital_Circus_-_Main_Theme.mp3',
    duration: '2:47'
  }
];
