...
const musicTracks = [
  { title: 'Running The Show', file: 'music/DIGITAL_CIRCUS_-_The_One_Who_s_Running_the_Show_Official_Music_Video.mp3', duration: '3:02' },
  { title: 'Your New Home', file: 'music/Your_New_Home.mp3', duration: '3:00' },
  { title: 'Theme from The Amazing Digital Circus', file: 'music/The_Amazing_Digital_Circus_-_Main_Theme.mp3', duration: '2:47' }
];
...
function loadTrack(index, autoplay = false) {
  ...
  const isSameTrack = musicAudio.getAttribute('src') === track.file;
  if (!isSameTrack) {
